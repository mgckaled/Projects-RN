...
// Definição de parâmtros de texto a partir de arrays
const fontStyles = ["normal", "italic"]; // 2 formas de estilo


const fontVariants = [  // tipos de variações de fontes
  undefined,
  "small-caps",
  "oldstyle-nums",
  "lining-nums",
...
const fontWeights = [ // peso das fontes 
  "normal",
  "bold",
  "100",
  "200",
...
// tipos de estilos de decoração em linha.
...
// Direção de escrita (em árabe é rtl -> right to left)
